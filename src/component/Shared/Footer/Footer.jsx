...
const Footer = () => {
    return (
        <div className="bg-blue-700 px-10 text-white">
                ...
                <div>
                    ...
                    <p className="font-bold">
                        <div className=" flex gap-5">
                            <a href="">Berhampore, Murshidabad, WB-742101</a>
            ...
            <footer className="footer p-10 py-20 justify-around ">
            ...
            <hr />
            <div className="py-20 justify-around flex">
